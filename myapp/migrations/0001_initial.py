# Generated by Django 4.1.7 on 2023-05-31 21:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('Men', 'Men'), ('Women', 'Women'), ('Men & Women', 'Men & Women')], max_length=50, null=True)),
                ('type', models.CharField(blank=True, choices=[('Chemise', 'Chemise'), ('T-shirt', 'T-shirt'), ('T-Pantalons', 'T-Pantalons'), ('T-Manteaux ', 'T-Manteaux '), ('pyjama', 'pyjama')], max_length=50, null=True)),
